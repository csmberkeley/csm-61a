...
"""
2. In an alternate universe, 61A software is not that good (inconceivable!). Laryn is in
...
sizes). Given a total number of students, can Laryn create sections and not have
...
"""
3. Realizing the need for improvement, Laryn has recruited you to help them make 61A
sections more flexible! Laryn would like discussion sections to have 20 ≤ x ≤ 30
