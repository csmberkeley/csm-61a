...
\section{Trees}
	...
	\question{Prune Tree}
	\begin{blocksection}
		Implement prune_tree which takes in a Tree t and an integer total and mutates t so that the sum of each
		root-to-leaf path is at most total. Assume values are positive numbers and t.root ≤ total.
		\begin{lstlisting}
			class Tree:
