...
\begin{itemize}
  ...
  \item Minilecture (optional) [5 min]
  \item Q1: What Would Python Display + explanations [10 minutes]
  \item Q2: Order of evaluation [5 min]
    \subitem{Note: don't need to do all parts if students get the idea}
  \item Q3: Power of 2 [8 min]
  \item Q4: Minimum Factorial [10 min]
  % \item Code Writing [20 minutes]
    \subitem{- Again, no need to do all questions}
    \subitem{- 3 is medium difficulty \& the last one is a bit more challenging, so pick questions/time based on how your students are feeling}
