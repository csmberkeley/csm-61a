...
\begin{meta}
    ...
    \begin{itemize}
        ...
        \item Mini-lecture: Python Expressions, Functions, Environment Diagrams, Control, and Higher-Order Functions [10 min]. Do each topic's mini-lecture right before the questions for that section and do not do a whole big mini-lecture in the beginning.
        \item Q1: Potpourri [5 min]
            \subitem{Feel free to skip some parts!}
        \item Q2: Funky Functions [7 min]
        \item Q3: Score Needed [7 min]
        \item Q4: Swap [10 min]
        \item Q5: Divisibility Check [5 min]
        \item Q6: Fizz Buzz [7 min]
        \item Q7: Whole Sum [10 min]
...
\begin{questions}
    ...
    \begin{questionmeta}
        Suggested Time: 10 min
        \begin{itemize}
            \item Emphasize when a new frame is created and how local assignments differ from global assignments.
            \item Track the return value of \lstinline{print} and the resulting value of \lstinline{a}.
        \end{itemize}
    \end{questionmeta}
\end{questions}
...
\begin{questions}
    ...
    \begin{questionmeta}
        Suggested Time: 10 min
        \begin{itemize}
            \item Connect the returned function to the idea of a predicate that produces \lstinline{True} or \lstinline{False}.
            \item Trace one iteration of the \lstinline{while} loop before students complete the implementation.
        \end{itemize}
    \end{questionmeta}
\end{questions}
