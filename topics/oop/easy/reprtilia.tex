...
\begin{blocksection}
    \question Your friend, Julian, decides to create a new object class based off of Reprtilia called ReprtiliaNoises, and as such, decides to overhaul your \lstinline{__repr__} and \lstinline{__str__}! How would the following be implemented following the doctests?
    ...
    \begin{blocksection}
        \question How does Julian redefine the \lstinline{__init__}  method?
    ...
    \begin{blocksection}
        \question How does Julian redefine the \lstinline{__repr__} and \lstinline{__str__} method?
    ...
    \begin{blocksection}
        \question How does Julian redefine the \lstinline{__str__} method?
