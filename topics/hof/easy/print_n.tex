...
\begin{blocksection}
    \begin{guide}
      \textbf{Teaching Tips}
      \begin{itemize}
             \item Make sure to explain why we return print_n(n-1) instead of modifying n in place.
             \item Feel free to walk through some examples as well before going into the problem itself. 
      \end{itemize}
    \end{guide}
   \end{blocksection}
