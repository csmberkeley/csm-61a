...
\begin{blocksection}
    ...
    Laryn is in charge of assigning students to discussion sections, but sections.cs61a.org 
    only knows how to list sections with either \lstinline$m$ or \lstinline$n$ number of students (the two most popular sizes). 
    Given a \lstinline$total$ number of students, can Laryn create sections and not have any leftover students? 
