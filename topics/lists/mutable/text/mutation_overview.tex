...
\newline
\includegraphics[width=.9\textwidth]{newlist-mutation.png}
	...
	\begin{itemize}
			...
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item Tell them to reference the list mutability table. Come up and go over examples for each one of them so as to reinforce concepts before trying spooky out.
				\end{itemize}
			\end{itemize}
