\begin{blocksection}
    ...
    \begin{questionmeta}
        ...
        \begin{enumerate}
                ...
                \item Python is confusing when adding on to a list with \lstlinline{lst += [element]} and \lstinline{lst = lst + element}. The former mutates and the latter creates a new list
