SQL (Structured Query Language) is a declarative programming language. In declarative languages, programs are instructions that the interpreter uses to generate a desired result. 
