\begin{blocksection}
    ...
    \begin{blocksection}
    \question How can we write the fixed \textinline{pokemon\char`_roster} function for
    the constructors and selectors in the previous question?
    
    \begin{solution}[1.5in]
    No change is necessary to fix \textinline{pokemon\char`_roster} since using the
